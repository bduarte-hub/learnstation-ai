...
const LANGS = {
  en: {
    ...
    mod_agenthr_desc: 'How agentic AI is transforming HR — real applications in recruitment, onboarding, L&D and workforce planning.',
    ...
    mod_agentsrec_desc: 'Practical applications of AI agents in recruitment — sourcing, screening and candidate experience.',
  ...
  pt: {
    ...
    mod_agenthr_desc: 'Como a IA agêntica está transformando o RH — aplicações reais em recrutamento, onboarding, L&D e planejamento de headcount.',
    ...
    mod_agentsrec_desc: 'Aplicações práticas de agentes de IA no recrutamento — sourcing, triagem e experiência do candidato.',
...
const STAGES = [
  { id:'s1', get label(){return t('s1_label')}, icon:'ti-brain',
    ...
    mods:[
      ...
      {id:'agentic-hr',  type:'link', url:'https://www.linkedin.com/learning/preparing-hr-teams-for-agentic-ai/the-power-of-agentic-ai-in-hr?u=451056106',                          title:'The Power of Agentic AI in HR',           src:'linkedin', srcL:'LinkedIn Learning', get desc(){return t('mod_agenthr_desc')},       dur:'~3min',    req:true},
      ...
      {id:'fluency',     type:'link', url:'https://anthropic.skilljar.com/ai-fluency-framework-foundations',                                                                          title:'AI Fluency: Framework & Foundations',     src:'anthropic',srcL:'Anthropic',         get desc(){return t('mod_fluency_desc')},        dur:'~2h',      req:true},
      ...
      // Optional modules
      {id:'agents-rec',  type:'link', url:'https://www.linkedin.com/learning/leveraging-agentic-ai-in-hr/using-ai-agents-in-recruitment?u=451056106',                               title:'Using AI Agents in Recruitment',          src:'linkedin', srcL:'LinkedIn Learning', get desc(){return t('mod_agentsrec_desc')},     dur:'~3min',    req:false},
