...
async function onRequestPost({ request, env }) {
  ...
  try {
    ...
    if (!login || score === void 0) {
      return new Response(JSON.stringify({ error: "login e score s\xE3o obrigat\xF3rios" }), { status: 400, headers: cors });
    }
...
async function onRequestPost2({ request, env }) {
  ...
  try {
    ...
    record.progress[episodeId] = done ? (/* @__PURE__ */ new Date()).toISOString() : null;
...
async function onRequestGet2({ request, env }) {
  ...
  const url = new URL(request.url);
  if (url.searchParams.get("pwd") !== ADMIN_PWD2) {
    return new Response(JSON.stringify({ error: "unauthorized" }), { status: 401, headers: cors });
  }
  try {
...
// ../.wrangler/tmp/pages-NwW3Uh/functionsRoutes-0.15539129519468942.mjs
var routes = [
  {
    routePath: "/api/enps",
    mountPath: "/api",
...
// ../.wrangler/tmp/bundle-PoHWFR/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-PoHWFR/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.2332124506575427.mjs.map
